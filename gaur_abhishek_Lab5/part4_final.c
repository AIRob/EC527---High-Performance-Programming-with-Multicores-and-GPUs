...
//void strip_vec(vec_ptr v, long int strip_num, long int vec_size, long int total_strips)
//{
//	long int elements_per_strip = strip_num * vec_size;
//	long int total_elements = elements_per_strip * total_strips;
//	vec_ptr result[total_strips];
//	
//	int i,j,k,l;
//	
//	for(i=0;i<total_strips;i++)
//	{
//		result[i]=new_vec(elements_per_strip);
//	}
//	
//	
//
//	for(k=0;k<total_elements;k=k+elements_per_strip)
//	{
//		for(i=k,j=0;i<k+elements_per_strip,j<elements_per_strip;i++,j++)
//		{
//			result[l]->data[j] = v->data[i];
//		}
//		l++;
//	}
//	
...
//	{
//		printf("\nStrip %d: \n",i);
//		for(j=0;j<elements_per_strip;j++)
//		{
//				printf("%.4f ",(data_t)(result[i]->data[j]));
//		}
//	}
//}
